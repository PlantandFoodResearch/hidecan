...
vignette: >
  %\VignetteIndexEntry{gwaspoly_output}
...
An example of GWASpoly output, based on the [original example dataset](https://acsess.onlinelibrary.wiley.com/doi/10.3835/plantgenome2015.08.0073) from the GWASpoly package, can be obtained with the `get_gwaspoly_example_data()` function:
...
The example dataset provided through `get_gwaspoly_example_data()` can be reproduced with the following code:
