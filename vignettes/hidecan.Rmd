...
```{r hidecan-plot, fig.width = 10, fig.height = 11}
hidecan_plot(
...
```{r hidecan-select-chroms, fig.width = 10, fig.height = 3.5}
hidecan_plot(
  qtl_list = x[["QTL"]],
  gwas_list = x[["GWAS"]],                    
  de_list = x[["DE"]],                          
...
```{r hidecan-chrom-limits-all-chrom, fig.width = 10, fig.height = 11}
hidecan_plot(
  qtl_list = x[["QTL"]],   
  gwas_list = x[["GWAS"]],                    
  de_list = x[["DE"]],                          
...
```{r hidecan-chrom-limits-some-chrom, fig.width = 10, fig.height = 11}
hidecan_plot(
  qtl_list = x[["QTL"]], 
  gwas_list = x[["GWAS"]],                    
  de_list = x[["DE"]],                          
...
```{r hidecan-select-chroms-and-chrom-lims, fig.width = 10, fig.height = 3.5}
hidecan_plot(
  qtl_list = x[["QTL"]],
  gwas_list = x[["GWAS"]],                    
  de_list = x[["DE"]],                          
...
If you want to represent different sets of QTL regions which would be coloured by track rather than score, see the example at the end of the ["Controlling the aesthetics" section](hidecan.html#controlling-the-aesthetics-colours-point-shapes-labels-of-the-tracks).
...
```{r hidecan-chrom-length, fig.width = 10, fig.height = 11}
hidecan_plot(
  qtl_list = x[["QTL"]],
  gwas_list = x[["GWAS"]],          
  de_list = x[["DE"]],              
...
```{r hidecan-ncols, fig.width = 10, fig.height = 11}
...
```{r show-hidecan-multiple-qtls, fig.width = 10}
library(ggplot2)
...
ggplot2::ggsave("hidecan_plot.pdf", p, width = 10, height = 11)
```
