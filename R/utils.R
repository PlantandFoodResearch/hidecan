...
#'
#' The dataset used in this example is presented in: [Angelin-Bonnet et al., BMC
#' Plant Biology (2023)](https://doi.org/10.1186/s12870-023-04255-2). In this
...
#' measured. The GWAS analysis was carried with the `GWASpoly` package. In
